...
import pandas as pd
import numpy as np
#This code was created as part of the Data Science with Python Udacity Nanodegree course
...
def user_stats(df):
    ...
    if 'Gender' in df.columns:
        ...
        print('This dataset does not cntain Gender data')
    ...
    if 'Birth Year' in df.columns:
        ...
        print('This dataset does not cntain Birth Year data')
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('-'*40)

def display_raw_data(df):
    """ Interacts with user to let them see raw data on demand"""
    i = 0
    ...
    while True:            
        if raw == 'no':
            ...
            raw = input("Would you like to see another 5 rows?\n").lower() # TO DO: convert the user input to lower case using lower() function
            i += 5
        else:
